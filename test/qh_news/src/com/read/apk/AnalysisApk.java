...
public class AnalysisApk {
	 ...
	 * @throws IOException
	 */
	public static ApkInfo unZip(  InputStream is) {
		// [0]:版本号;[1]包名
								...
								case XmlPullParser.START_TAG: {
									for (int i = 0; i != parser.getAttributeCount(); ++i) {
										if ("versionName".equals(parser.getAttributeName(i))) {
											...
											apkInfo.setApkName(getAttributeValue(parser, i));
										}
									}
								}
								}
...
//	
//	public static ApkInfo unZip(String apkUrl, String logoUrl,InputStream is) {
//		// [0]:版本号;[1]包名
//		// String[] st = new String[2];
//		byte b[] = new byte[1024];
//		int length;
